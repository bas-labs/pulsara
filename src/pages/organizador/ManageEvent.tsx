      ...
      <div className="grid grid-cols-3 gap-4 mb-10">
        <Card>
          <CardContent className="p-5 text-center">
            <p className="text-3xl font-bold text-zinc-900">{confirmed}</p>
            <p className="text-sm text-zinc-500">Inscritos</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-5 text-center">
            <p className="text-3xl font-bold text-zinc-900">{event.spotsRemaining ?? '—'}</p>
            <p className="text-sm text-zinc-500">Lugares restantes</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-5 text-center">
            <p className="text-3xl font-bold text-zinc-900">{event.totalSpots ?? '—'}</p>
            <p className="text-sm text-zinc-500">Capacidad total</p>
          </CardContent>
        </Card>
      </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {registrations.map(reg => (
                  <tr key={reg.id} className="border-b border-zinc-50 hover:bg-zinc-50">
