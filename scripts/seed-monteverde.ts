/**
 * Seed the Carrera Monteverde event into sandbox + production
 * Run: npx tsx scripts/seed-monteverde.ts
 */
...
const SUFFIXES: Record<string, string> = {
  sandbox: 'tcnflzpturdtratjqzwrhjyu3a-NONE',
  production: 'rszfui4pcverxmcgqwevohelna-NONE',
}

async function seed() {
  for (const [env, suffix] of Object.entries(SUFFIXES)) {
    console.log(`\n🌱 Seeding Carrera Monteverde into ${env}...`)
